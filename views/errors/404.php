...
<title>404 — Halaman Tidak Ditemukan | TravelKu</title>
...
<div class="wrap">
  ...
  <p>Maaf, halaman yang Anda cari tidak ada atau telah dipindahkan. Silakan kembali ke beranda.</p>
  <div class="actions">
    <a href="<?= (defined('SUBFOLDER') ? SUBFOLDER : '') . '/' ?>" class="btn btn-primary">🏠 Ke Beranda</a>
